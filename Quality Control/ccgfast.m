...
function [K, Qi, Q00, Q01, Ri, Qin, Qin1] = ccgfast(st1, st2, nbins, tbin)
%
...
if isempty(st1) || isempty(st2) % for cases with empty spikes
   K = nan(2*nbins+1, 1);
   [Qi,Ri] = deal(nan(1,10));
   [Q00, Q01, Qin, Qin1] = deal(nan(1,1));
   return;    
end
