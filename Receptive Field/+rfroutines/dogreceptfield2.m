...
%==========================================================================
%get circular guess
circguess = rfroutines.fitCircDogRF((spx-cx)/dx,(spy-cy)/dy, img);
...
A=[]; b=[]; 
%==========================================================================
[fstart, startGrad] = rfroutines.dogmatrixfun(guess,{X(:), Y(:)}); %calculate gradient at initial point
...
[lf,lg]= rfroutines.dogmatrixfun(p,X);
