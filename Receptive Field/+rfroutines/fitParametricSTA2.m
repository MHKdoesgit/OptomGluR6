...
%==========================================================================
%Setup sta range
tvec = rfroutines.templowpass(tempGuess,tt);
...
[~,startGrad] = rfroutines.tempDOG3DFun(guessfit,{T(:), X(:), Y(:)}); %calculate gradient at initial point
...
Z = rfroutines.tempDOG3DFun(params,{T(:), X(:), Y(:)});

rsq = rfroutines.rsquare(stafit(:),Z);
...
[lf,lg] = rfroutines.tempDOG3DFun(p,X);
